  ...
  return (
    <>
      <button
        ...
        className="fixed right-0 top-1/2 -translate-y-1/2 bg-custom-gradient text-white md:px-3 md:py-5 px-2 py-4 rounded-l-lg hover:bg-blue-700 transition-colors"
