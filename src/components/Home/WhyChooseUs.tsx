...
const deliverables: Deliverable[] = [
  ...
  { id: 3, title: '30+ Hours of Expert-Led Live Training', description: 'Interactive sessions led by industry experts.', icon: books },
  { id: 4, title: '1000+ Free Practice Questions', description: 'Extensive question bank for comprehensive practice.', icon: questions },
  { id: 5, title: '21 IIBA PD Hours', description: 'Accredited professional development hours.', icon: clock },
  ...
  { id: 8, title: '10+ hours of ECBA Video Learning', description: 'Engage with detailed video lessons.', icon: recordings },
    ...
    <div className="bg-custom-gradient py-10  px-4 " id="Why-choose-us">
      <div className="container mx-auto md:px-6 lg:px-20">
        <h2 className="text-xl md:text-4xl font-bold text-white mb-6 text-center">
          Why ECBA Course from <br /> ADAPTIVEUS ?
        </h2>
